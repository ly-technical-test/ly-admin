export const ERROR_TRANSLATIONS = {
  ...
  lytex_invoice_creation_not_allowed: 'A emissão de cobranças não está disponível no momento.',
  lytex_invoice_limit_exceeded: 'O teto de emissão de cobranças foi atingido.',
  lytex_invoice_max_value_exceeded: 'O valor da cobrança excede o limite máximo permitido.',
